...
cases:
  ...
  - link:
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Cigomático unilateral </h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
  ...
  - link:
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Implantación mixta y función inmediata </h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Control postquirúrgico y prótesis definitiva</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Resolución estética en reborde atrófico</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
  ...
  - link:
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Aspecto quirúrgico y postquirúrgico</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>técnica clásica de Brånemark</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>prótesis híbrida metal-acrílico</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
  ...
  - link:
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Dentadura total implantosoportada </h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Restitución de la plenitud facial </h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
  ...
  - link:
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>Técnica paramaxilar o extrasinusal</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
  ...
  - link:
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>implantación con prf</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>inicio fase restauradora</h6>
  - link:
      display: false
      to: /pacientes-del-exterior/
    ...
    placeholder: >
      <span> Ver más </span>
    body: <h6>híbrida metal-porcelana</h6>
  ...
  items:
    - img: /uploads/sections-3d-diagnosis.png
      ...
      footer:
        ...
        link:
          display: true
          to: /especialidades/implantes-dentales/diagnostico-y-planificacion-30
