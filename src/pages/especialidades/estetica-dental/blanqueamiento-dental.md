...
heading:
  ...
  title: Blanqueamiento Dental
  content: '<p class="dv-subtitle text-center">Consiste en el tratamiento de las superficies
...
sidePanel:
  ...
  - img: "/img/sections-teeth-whitening-clinic.png"
    section: '<div class="dv-sp-srv-cd"><h2 class="dv-srv-pl4 dv-pb-15em">Blanqueamiento
      ...
      luz o fotoradiación. Se trata de un procedimento mucho más avanzado, en el que
      una sola sesión de 45 minutos, se logran usualmente resultados notables.</p><p
...
'
  - img: "/img/sections-teeth-whitening-intern.png"
    section: '<div class="dv-sp-srv-cd"><h2 class="dv-srv-pr dv-srv-pr-45">Blanqueamiento
      interno</h2><p class="dv-srv-pr dv-srv-pr-45">Es una excelente alternativa para
...
slogan:
  ...
  description: Luzca más joven y presuma del tratamiento estético más rápido, seguro
...
'
    - img: "/img/teeth-whitening-list-02.png"
      number: 2
      title: '<h2>Desensibilización</h2><p class="dv-div-text list">La aplicación
...
'
    - img: "/img/teeth-whitening-list-04.png"
      ...
      title: '<h2>Dosificación</h2><p class="dv-div-text list">Preparación del gel
        blanqueador, generalmente a base de peróxidos, segun las concentraciones previamente
...
'
    - img: "/img/teeth-whitening-list-07.png"
      number: 7
      title: '<h2>Remoción y limpieza</h2><p class="dv-div-text list">Aspiración del
...
'
    - img: "/img/teeth-whitening-list-08.png"
      number: 8
      title: '<h2>Valoración final</h2><p class="dv-div-text list">Análisis objetivo
...
paragraphSection:
  align: right
  body: '<p class="dv-div-title dv-pb-40">Beneficios de un blanqueamiento dental profesional</p>
