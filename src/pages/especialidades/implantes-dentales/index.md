...
faq:
  ...
  - questions:
    - question: "¿Qué es la oseointegración?"
      answer: "<p>Se define como el proceso biológico mediante el cual se logra una
    ...
    - question: "¿Existen contraindicaciones al tratamiento con implantes?"
      answer: "<p>Por norma general son las mismas que impiden ejecutar otros procedimientos
        ...
        severa, diabetes mellitus no controlada y enfermedades óseas como osteoporosis
        y osteomalacia. También, es importante valorar otros factores adicionales
        como la ingesta de bifosfonatos en mujeres, presencia de infección periodontal
    ...
    - question: "¿Podrían ser necesarias otras cirugías especiales?"
      answer: "<p>Lamentablemente en algunos casos la cantidad, calidad y densidad
        del hueso receptor pueden ser deficientes y suele ser entonces necesario colocar
        injertos óseos autógenos o sintéticos para mejorar el entorno local y evitar
        un posible fracaso. Otra maniobra relativamente común es la elevación del
    ...
    - question: "¿Qué son los implantes inmediatos?"
      answer: "<p>Son aquellos que se colocan en el mismo momento de la extracción
        ...
        estéticos de la restauración final. Una ventaja adicional es que acortan considerablemente
        el tiempo total de tratamiento, al no ser necesario esperar los 4 o 5 meses
  ...
  - questions:
    ...
    - question: "¿Qué es la periimplantitis?"
      answer: "<p>Los implantes y los dientes naturales son tan parecidos que son
        ...
        la periodontitis, existe la periimplantitis, ambas enfermedades bacterianas
        e inflamatorias que destruyen el hueso alveolar, causan movilidad de dientes
        e implantes, y en casos extremos; pérdida de los mismos.</p>\n"
    - question: "¿Cómo hacer entonces para prevenirla?"
      answer: "<p>Lo primero es cerciorarse de la preparación y capacidad de los profesionales
        que llevarán a cabo su tratamiento. Para esto Usted no necesita un odontólogo,
        usted necesita un EQUIPO DE TRABAJO conformado por un Cirujano, un Prostodoncista
        y un Periodoncista que dominen y tengan experiencia en la materia. Luego,
        es indispensable su colaboración. La higiene oral es el pilar fundamental
...
clinicCases:
  ...
  - image: "/img/clinic-cases-dental-implants-es-01-thumb.jpg"
    title: "<h6>9 Implantes y Prótesis Parcial Híbrida Superior </h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-02-thumb.jpg"
    title: "<h6>Rehabilitación Oral Completa </h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-03-thumb.jpg"
    title: "<h6>Prótesis Parcial Fija Implantosoportada</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-04-thumb.jpg"
    title: "<h6>Reposición de Incisivos Inferiores</h6>\n"
  ...
  - image: "/img/clinic-cases-dental-implants-es-06-thumb.jpg"
    title: "<h6>Implantes en Correspondencia con 1.2 y 2.2</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-07-thumb.jpg"
    title: "<h6>2 Implantes y Puente Fijo Inferior</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-08-thumb.jpg"
    title: "<h6>Healing Caps y 6 Coronas Metal-Porcelana</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-09-thumb.jpg"
    title: "<h6>Sobredentadura Removible</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-10-thumb.jpg"
    title: "<h6>Implantación en Correspondencia con el 2.1 </h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-11-thumb.jpg"
    title: "<h6>Tornillo de Cicatrización y Corona Anterior</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-12-thumb.jpg"
    title: "<h6>Antes y Después con Implantes y Coronas Cerámicas</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-13-thumb.jpg"
    title: "<h6>Implante Unitario en Región de Bicúspides</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-14-thumb.jpg"
    title: "<h6>Abutments o Pilares Protésicos</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-15-thumb.jpg"
    title: "<h6>Prótesis Total Híbrida Metal-Acrílico</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-16-thumb.jpg"
    title: "<h6>Híbrida Superior Sobre 8 Implantes </h6>\n"
  ...
  - image: "/img/clinic-cases-dental-implants-es-18-thumb.jpg"
    title: "<h6>Prótesis Fija Convencional e Implante Unitario</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-19-thumb.jpg"
    title: "<h6>Prótesis Fija Superior Implantosoportada</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-20-thumb.jpg"
    title: "<h6>Rehabilitación Bimaxilar con Implantes Dentales</h6>\n"
  - image: "/img/clinic-cases-dental-implants-es-21-thumb.jpg"
    title: "<h6>Implante en Zona de Alto Compromiso Estético</h6>\n"
  lightbox:
...
'
    content: '<p style="font-weight:400">La aparición y desarrollo de técnicas avanzadas
...
'
    ...
    footer:
      ...
      button:
        ...
        display: true
  - align: right
    title: '<h3 style="color:#333;font-family:''Bebas Neue Bold''">Prótesis Sobre
      Implantes</h3>
...
lightQuote:
  ...
  content: AHORA QUE LLEVO IMPLANTES NO PUEDO ENTENDER CÓMO ESTUVE TANTO TIEMPO USANDO
