...
prices:
  footer:
    ...
    title: "<p>Prices expressed in American dollars <em>(USD)</em>.<br>Convert them
...
sidePanel:
  ...
  - img: "/img/sections-dental-tourism-calculator.png"
    section: |
      ...
      <p class="dv-srv-pl text-left dv-npr">Have you visited several Dentists and still cannot find a treatment option that is truly within your means? Want to get more out of your money? </p>
  ...
  - img: "/img/sections-dental-tourism-hotel.png"
    section: |
      ...
      <p class="dv-srv-pl text-left dv-npr">ESTIMATED COST PER DAY: 50.00 USD <em>(meals not included)</em>.</p> <br><br> <a class="text-left">CHACAO SUITES</a> &nbsp;&nbsp;&nbsp; <a class="text-left">SHELTER SUITES</a> </div>
  - img: "/img/sections-dental-tourism-24.png"
    section: |
      <div class="dv-sp-srv-cd">
      <h2 class="dv-srv-pl4 text-right dv-npr">Full travel assistance and permanent support</h2> <p class="dv-srv-pl text-right dv-npr">Our administrative staff is able to provide you support in everything related to air ticketing, airport-hotel-airport transfers and accommodation procedures. </p>
