...
hero:
  ...
  parallax: false
  title: '<span class="bebas" style="font-family:Bebas Neue Bold;color:white;font-weight:lighter">ZYGOMATIC
    IMPLANTS</span>
...
faq:
  ...
  - questions:
    ...
    - question: Is it a painful treatment?
      answer: "<p>Not at all, since it is almost always done under general anesthesia.
        ...
        and allows the patient to rejoin his daily life in a very short time. Even
        so, the prescription of an analgesic protocol completely individualized will
        be routine and will ensure effective control of post-surgical pain in the
  ...
  - questions:
    - question: How is the surgery and how long does it last?
      answer: |
        <p>The 4 most prominent techniques are that of Brånemark, that of Stella and Warner <em>(Sinus Slot Technique)</em>, the paramaxillary or extrasinusal technique and the ZAGA <em>(Zygoma Anatomy-Guided Approach)</em> technique of Dr. Carlos Aparicio. In the classical or Brånemark technique, Zygomatic Implants are placed maneuvering through the maxillary sinus, until the zygomatic arch is reached. In the Stella and Warner's, a more direct visualization of the base of the malar bone is achieved, thanks to the opening of a large window in the lateral wall of the paranasal antrum. In the extrasinusal, the implants are placed by the outside the maxillary bone, without involving the sinus; and in the ZAGA methodology, any possible combination of the 3 previous techniques is contemplated, in order to perform a more individualized surgery, adapted to the particular anatomy of each person.</p>
        <p>Logically, depending on the complexity of the case, number of devices to be implanted, type of approach selected, and of course, the skill of the Surgeon; between 30 and 120 minutes is the period of time necessary to anesthetize, make incisions, dissect tissues, stipulate measures and approximations, select implants, mill, drill, screw, clean and suture the wound.</p>
    ...
    - question: How is the postoperative period and how long does it take for the
        patient to recover?
      answer: "<p>The postoperative period does not usually involve major complications,
    ...
    - question: After the treatment, what should I do to keep my implants for a lifetime?
      answer: "<p>Basically keep yourself in good general health, practice very good
        ...
        inspect and clean the implants and prosthetic attachments, the soft tissue
...
clinicCases:
  ...
  - image: "/img/clinic-cases-zygomatic-implants-en-10-thumb.jpg"
    title: "<h6>REIMPLANTATION CASE</h6>\n"
  - image: "/img/clinic-cases-zygomatic-implants-en-11-thumb.jpg"
    title: "<h6>IMPLANT SUPPORTED TOTAL DENTURE</h6>\n"
  - image: "/img/clinic-cases-zygomatic-implants-en-12-thumb.jpg"
    title: "<h6>RESTITUTION OF FACIAL PLENITUDE</h6>\n"
  ...
  - image: "/img/clinic-cases-zygomatic-implants-en-14-thumb.jpg"
    title: "<h6>PARAMAXILLARY OR EXTRASINUSAL TECHNIQUE</h6>\n"
  ...
  - image: "/img/clinic-cases-zygomatic-implants-en-16-thumb.jpg"
    title: "<h6>IMPLANTATION WITH PRF</h6>\n"
  - image: "/img/clinic-cases-zygomatic-implants-en-17-thumb.jpg"
    title: "<h6>START OF THE PROSTHETIC PHASE</h6>\n"
  - image: "/img/clinic-cases-zygomatic-implants-en-18-thumb.jpg"
    title: "<h6>METAL-PORCELAIN FULL ARCH HYBRID PROSTHESIS</h6>\n"
  lightbox:
...
'
    ...
    footer:
      ...
      button:
        ...
        display: true
  - align: left
    title: '<h3 style="color:#333;font-family:''Bebas Neue Bold''">SEDATION AND GENERAL
      ANESTHESIA</h3>
...
lightQuote:
  ...
  content: THIS TECHNIQUE IS A TRUE BLESSING, AND EVEN MORE AFTER AN EXPERIENCE LIKE
    MINE, IN WHICH BY UNKNOWLEDGE OR DESIDIA, A DENTIST OF MY COUNTRY CONDEMNED ME
    TO USE FOR YEARS A REMOVABLE DENTURES THAT WERE NOT HELD BY ANYTHING IN THE WORLD".
form:
