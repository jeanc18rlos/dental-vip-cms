  ...
  - questions:
    - question: What is the dental reshaping or cosmetic contouring?
      answer: "<p>Over the years, the teeth wear out and suffer microfractures that
        alter their natural shape and age the appearance of the dentition. With only
    ...
    - question: Which is then better for a front tooth, a veneer or a crown?
    ...
    - question: Are all veneers of porcelain?
      answer: "<p>No! They can also be made of composite resins by direct technique,
        ...
        life than ceramic veneers. The latters can remain up to 20 years in the mouth.</p>\n"
...
asides:
  ...
  sections:
  - align: right
    title: <h3 style="color:#333;font-family:'Bebas Neue Bold'">FOR A WHITER AND BEAUTIFUL
      TEETH!</h3>
...
lightQuote:
  ...
  content: I AM WONDERFUL WITH MY NEW SMILE, THE CHANGE WAS DRASTIC AND SPECTACULAR.
    MY TEETH WERE VERY ROUND, SMALL, YELLOW AND SOMETHING SEPARATED. NOW THEY ARE
    BEAUTIFUL LIKE THOSE OF CELEBRITIES. WITHOUT DOUBT A TREATMENT THAT EXCEEDED ALL
    MY EXPECTATIONS".
form:
