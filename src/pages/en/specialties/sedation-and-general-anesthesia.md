...
hero:
  ...
  title: <p>&lt;span class="bebas" style="font-family:Bebas Neue Bold;color:white;font-weight:lighter"&gt;SEDATION
    AND  GENERAL&lt;br&gt;&lt;/br&gt;ANESTHESIA&lt;/span&gt;</p>
  indicator: false
  halfSize: true
specialtiesHeading:
  display: true
...
paragraphSection:
  body: "<p>Despite all the advances that Dentistry has experienced in recent years,
...
faq:
  ...
  - questions:
    ...
    - question: What is the difference between both and which is better?
      answer: "<p>Basically that in sedation reflexes, breathing control and responsiveness
        ...
        is asleep in a deep sleep, and airway protection and assisted ventilation
        are frequently required. In addition, cardiovascular function is usually also
    ...
    - question: In which cases is a sedation or deeper anesthesia recommendable?
      answer: "<p>There really is no clear consensus on the indications for the use
        ...
        maxillofacial surgery.</li> <li>Medically compromised patients and that their
  ...
  - questions:
    ...
    - question: How long will it take me to wake up after the intervention?
      answer: "<p>Conscious sedation is a technique that allows the rapid return of
