  ...
  - questions:
    ...
    - question: What are included teeth?
      answer: "<p> Dental inclusion is a developmental disorder in which a given tooth,
        ...
        examinations, usually a panoramic dental x-ray.</p>\n"
  - questions:
...
lightQuote:
  ...
  content: I WAS SUBMITTED TO SEVERAL EXTRACTIONS AND TWO BONE GRAFTS AS PREVIOUS
    PREPARATION TO DENTAL IMPLANTS PLACEMENT, AND TRULY, I CAN'T GO BETTER WITH DR.GARABÁN.
    HE IS VERY SUBTLE IN HIS WORK AND HIS GREAT SKILL AND PROFESSIONAL EXPERIENCE
